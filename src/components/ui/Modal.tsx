...
export default function Modal({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 w-full max-w-lg rounded-md bg-white shadow-2xl transform transition-all duration-500 ${isOpen ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"}`}
      >
